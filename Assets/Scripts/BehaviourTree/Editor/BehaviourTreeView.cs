...
using System.Linq;
    ...
    public class BehaviourTreeView : GraphView {
        ...
        public ScriptTemplate[] scriptFileAssets = {
            ...
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateOptionNode, defaultFileName="NewOptionNode.cs",subFolder="Options" },
        };
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
            ...
            evt.menu.AppendAction($"Create Script.../New Option Node", (a) => CreateNewScript(scriptFileAssets[3]));
            ...
            {
                var types = TypeCache.GetTypesDerivedFrom<OptionNode>();
                foreach(var type in types)
                {
                    evt.menu.AppendAction($"[Option]/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }
